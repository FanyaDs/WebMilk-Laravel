...
--
-- Host: localhost:3306
-- Waktu pembuatan: 06 Jun 2024 pada 18.20
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
(1, 'Susu Sapi', '200000', 'Enak Mantap', '1717696035_susu sapi.jpg', NULL, NULL);
...
(5, '2024_06_06_163205_create_categories_table', 1),
(6, '2024_06_06_170630_create_transactions_table', 1);
...
(1, 'Fanya', '085161921998', 'Bali', 1, 200000, 'succes', '2024-06-06 10:47:36', '2024-06-06 10:47:36');
...
--
ALTER TABLE `categories`
  MODIFY `id_categories` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
